...
![image-20230310124252270](6、堆.assets/image-20230310124252270.png)
...
![image-20230310142845884](6、堆.assets/image-20230310142845884.png)
...
![image-20230310144513576](6、堆.assets/image-20230310144513576.png)
...
![image-20230310144530992](6、堆.assets/image-20230310144530992.png)
...
通常会将-Xms和-Xmx两个参数配置相同的值，<span style="color:red">其目的是为了能够在ava垃圾回收机制清理完堆区后不需要重新分隔计算堆区的大小，从而提高性能</span>。
...
![image-20230310154141292](6、堆.assets/image-20230310154141292.png)

新生代和老年代的占比情况

![image-20230310154745056](6、堆.assets/image-20230310154745056.png)
...
<span style="color:red">几乎所有的Java对象都是在Eden区被new出来的</span>。绝大部分的Java对象的销毁都在新生代进行了。

- IBM公司的专门研究表明，新生代中80%的对象都是“朝生夕死”的。

可以使用选项 <span style="color:red">`-Xmn`</span>设置新生代最大内存大小，这个参数一般使用默认值就可以了。

![image-20230310154838696](6、堆.assets/image-20230310154838696.png)
...
![image-20230310161252218](6、堆.assets/image-20230310161252218.png)

![image-20230310161312255](6、堆.assets/image-20230310161312255.png)

- 针对幸存者s0，s1区的总结：复制之后有交换，谁空谁是to

- 关于垃圾回收：频繁在新生区收集，很少在老年代收集，几乎不再永久代和元空间进行收集

# 四、Minor GC，MajorGC、Full GC
...
![image-20230310210113264](6、堆.assets/image-20230310210113264.png)
...
![image-20230310210643987](6、堆.assets/image-20230310210643987.png)

其实不分代完全可以，分代的唯一理由就是优化GC性能。如果没有分代，那所有的对象都在一块，就如同把一个学校的人都关在一个教室。GC的时候要找到哪些对象没用，这样就会对堆的所有区域进行扫描。而很多对象都是朝生夕死的，如果分代的话，把新创建的对象放到某一地方，当GC的时候先把这块存储“朝生夕死”对象的区域进行回收，这样就会腾出很大的空间出来。

![image-20230310210710588](6、堆.assets/image-20230310210710588.png)
...
## 7.1、 为什么有TLAB（Thread Local Allocation Buffer）？
...
- ![image-20230310220153708](6、堆.assets/image-20230310220153708.png)
...
![image-20230310220610516](6、堆.assets/image-20230310220610516.png)
...
没有发生逃逸，则这个对象可以被分配到栈上，随着方法的结束，栈空间就会被移除，每一个栈里面包含许多的栈帧。
...
这个逃离了方法区，所以产生了逃逸，如果不想让它产生逃逸，需要按照以下的方式进行书写。
